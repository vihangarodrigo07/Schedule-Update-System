...
const styles = {
  ...
  logoIcon: { backgroundColor: 'white', borderRadius: '4px', padding: '5px' },
  navLinks: { display: 'flex', flexDirection: 'column', gap: '15px', flex: 1 },
  link: { color: '#CBD5E1', textDecoration: 'none', display: 'flex', alignItems: 'center', gap: '10px', fontSize: '15px' },
  bottomNav: { borderTop: '1px solid #1E293B', paddingTop: '20px' },
  logoutBtn: { background: 'none', border: 'none', color: '#CBD5E1', cursor: 'pointer', display: 'flex', alignItems: 'center', gap: '10px', padding: 0, marginTop: '15px' },
  ...
  avatar: { width: '35px', height: '35px', borderRadius: '50%', backgroundColor: '#002855', color: 'white', display: 'flex', justifyContent: 'center', alignItems: 'center', fontSize: '12px' },
